...
clust_meta_with_facility_heatmap <- (
    ...
    plot_layout(widths=c(1,0.9,0.05,0.05,0.05,0.05,0.05), guides="collect") &
    theme(plot.tag = element_text(face="bold", vjust=-3.3),
          legend.position = "bottom",
          legend.direction = "vertical", legend.box = "horizontal")

ggsave(file=file.path(figs_dir, "FigureS7a_PooledEstimatesWithFacilityDetails.png"),
       plot=clust_meta_with_facility_heatmap, 
       width=15, height=10, bg='white')
ggsave(file=file.path(figs_dir, "FigureS7a_PooledEstimatesWithFacilityDetails.pdf"),
       plot=clust_meta_with_facility_heatmap, 
       width=15, height=10, bg='white')
...
ggsave(file=file.path(figs_dir, "FigureS7b_ClusterPropByFacilityCharacteristics.png"),
       plot=combined_facs_clust_prop_plots, width=14, height=7, bg='white')
ggsave(file=file.path(figs_dir, "FigureS7b_ClusterPropByFacilityCharacteristics.pdf"),
       plot=combined_facs_clust_prop_plots, width=14, height=7, bg='white')
...
ggsave(file=file.path(figs_dir, "Figure4_TransmissionPredictors.pdf"),
       plot=trs_model_and_intros_plot, width=12, height=20)
